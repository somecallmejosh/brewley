...
class ProductVariantsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create product_variant" do
    assert_difference("ProductVariant.count") do
      post product_variants_url, params: { product_variant: { name: @product_variant.name, price: @product_variant.price, product_id: @product_variant.product_id } }
    end
  ...
  test "should update product_variant" do
    patch product_variant_url(@product_variant), params: { product_variant: { name: @product_variant.name, price: @product_variant.price, product_id: @product_variant.product_id } }
